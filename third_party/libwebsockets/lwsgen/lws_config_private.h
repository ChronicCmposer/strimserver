...
/* Define to 1 if we have found rav1e via pkg-config */
/* #undef LWS_HAVE_RAV1E */

/* Define to 1 if we want to enable AV1 encoding in the mixer */
#define LWS_WITH_AV1_ENCODE
