...
#define LWS_PLUGIN_DIR "/usr/local/share/libwebsockets-test-server/plugins"
#define LWS_LIBRARY_VERSION_MAJOR 5
...
/* #undef LWS_HAVE_mbedtls_ssl_export_keying_material */
...
/* #undef LWS_HAVE_mbedtls_ssl_conf_ciphersuites */
/* #undef LWS_HAVE_mbedtls_ssl_session_save */
...
/* #undef LWS_HAVE_mbedtls_ssl_set_export_keys_cb */
/* #undef LWS_HAVE_mbedtls_ssl_conf_export_keys_cb */
/* #undef LWS_HAVE_mbedtls_ssl_set_quic_transport_ops */
...
/* #undef LWS_HAVE_SSL_set_tlsext_host_name */
...
#define LWS_LIBRARY_VERSION "5.0.0-unknown"
...
/* #undef LWS_WITH_SYS_ASYNC_DNS_DNSSEC */
/* #undef LWS_WITH_AUTHORITATIVE_DNS */
...
/* #undef LWS_WITH_HTTP3 */
/* #undef LWS_WITH_LS_QPACK */
...
/* #undef LWS_HAVE_MBEDTLS_V4 */
/* #undef LWS_WITH_BEARSSL */
/* #undef LWS_WITH_SCHANNEL */
/* #undef LWS_WITH_GNUTLS */
/* #undef LWS_WITH_OPENHITLS */
/* #undef LWS_WITH_TLS_KEYLOG */
/* #undef LWS_WITH_MINIZ */
#define LWS_WITH_ROUTING
#define LWS_WITH_NETLINK
#define LWS_WITH_BINDTODEVICE
#define LWS_WITH_NETWORK
/* #undef LWS_WITH_NO_LOGS */
/* #undef LWS_WITH_TRANSPORT_SEQUENCER */
/* #undef LWS_WITH_OTA */
...
/* #undef LWS_WITH_EXTIP */
/* #undef LWS_WITH_DHT */
/* #undef LWS_WITH_DHT_BACKEND */
/* #undef LWS_WITH_SYS_FAULT_INJECTION */
/* #undef LWS_WITH_SYS_METRICS */
/* #undef LWS_WITH_SYS_NTPCLIENT */
/* #undef LWS_WITH_SYS_WHOIS */
/* #undef LWS_WITH_LATENCY */
...
/* #undef LWS_WITH_TLS */
/* #undef LWS_WITH_TCP_TLS */
/* #undef LWS_WITH_TLS_JIT_TRUST */
/* #undef LWS_WITH_TLS_SESSIONS */
#define LWS_WITH_UDP
/* #undef LWS_WITH_DTLS */
...
/* #undef LWS_WITH_TRANSCODE */
/* #undef LWS_WITH_V4L2 */
/* #undef LWS_HAVE_LINUX_VIDEODEV2_H */
/* #undef LWS_HAVE_FFMPEG */
/* #undef LWS_WITH_ASYNC_QUEUE */
/* #undef LWS_WITH_MEDIA_RK_MPI */
